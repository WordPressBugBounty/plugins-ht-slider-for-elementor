...
class HTSlider_Dashboard_Widget {
    ...
    public function dashboard_widget() {
        ...
        wp_add_dashboard_widget(
            ...
            esc_html__( 'HasThemes Stories', 'ht-slider' ),
    ...
    private static function load_template( $template ) {
        $tmp_file = HTSLIDER_PL_INCLUDE . '/admin/templates/dashboard-' . $template . '.php';
