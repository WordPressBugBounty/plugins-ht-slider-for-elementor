...
= Version: 1.7.0 - Date: 2025-08-18 =
* Added: Pagination title tooltip in the Scroll Navigation Slider widget.
* Fixed: A few minor issues.
* Tested: Compatibility with latest version of Elementor.

= Version: 1.6.9 - Date: 2025-08-03 =
* Added: Exclude Slides option in HT Advanced Slider Widget.
* Fixed: A few minor issues.
* Tested: Compatibility with latest version of Elementor.
...
* Improved: Navigation arrow and dots styles in a separate section of the HT Slider Widget.
* Fixed: SVG icon color issue in the HT Slider Widget.

= Version: 1.6.3 - Date: 2025-02-09 =
* Fixed: Slide content gap not working in the Elementor Container flex layout.

= Version: 1.6.2 - Date: 2025-01-30 =
* Fixed: Slide content animation not working in the Elementor Container grid layout.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.
